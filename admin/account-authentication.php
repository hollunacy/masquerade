...
if (isset($_POST['login'])) {
  ...
  if (empty($_POST['email']) || empty($_POST['password'])) {
    ...
    $statement = $pdo->prepare("SELECT * FROM user_admins WHERE user_email=? AND user_status=?");
          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="../index.php" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-body fw-bolder">Masquerade</span>
              </a>
            </div>
            <!-- /Logo -->
